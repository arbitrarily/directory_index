...
<html lang="de">
  <head>
    <meta charset="utf-8"/>
    <style>body{background-color:#ddd;font-family:Cambria,serif;font-size:22px;font-style:normal;font-weight:400;text-transform:normal;letter-spacing:normal;line-height:1.3em;margin:4em 0}article,footer{display:block;margin:0 auto;width:60%}a{color:#046;text-decoration:none}a:hover{text-decoration:underline}a:visited{color:#666}h1{font-family:Helvetica,Arial,sans-serif;font-size:36px;font-style:normal;font-weight:700;text-transform:normal;letter-spacing:-2px;line-height:1.2em;margin-bottom:0;word-break:break-all}h1 span{font-family:Cambria,serif;font-size:13px;font-style:normal;font-weight:400;text-transform:uppercase;letter-spacing:1px;line-height:1.7em}ol{line-height:1.4em;list-style-type:lower-alpha;margin:5px 0}li.directory a:before{content:'[ '}li.directory a:after{content:' ]'}</style>
    <title>Directory Index</title>
  </head>
  <body>

    <article>
      <h1><span>Content of:</span> <br /><?php echo SHOW_PATH ? '<em>' . $path . '</em>' : 'this directory'; ?></h1>
      <h1><span>Directory Files:</span></h1>
      <ol>
        <?php
